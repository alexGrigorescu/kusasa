...
class Admin_Model_PageCategory extends Core_MainModel
{
    public $id;
    public $name;
    public $added;
	...
	public function __construct($id = 0){
		if($id != 0){
			parent::__construct('Admin_Model_DbTable_PageCategory', $id);
		}else{
			parent::__construct('Admin_Model_DbTable_PageCategory');
		}
	}
